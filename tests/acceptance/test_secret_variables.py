...
class TestSecretVariables:
    def test__builds_disabled(self, gitlab, group, project):
        ...
        run_gitlabform(config_builds_not_enabled, group_and_project_name)
    ...
    def test__single_secret_variable(self, gitlab, group, project):
        group_and_project_name = f"{group}/{project}"
        ...
        run_gitlabform(config_single_secret_variable, group_and_project_name)

        secret_variables = gitlab.get_secret_variables(group_and_project_name)
        assert len(secret_variables) == 1

    def test__delete_secret_variable(self, gitlab, group, project):
        group_and_project_name = f"{group}/{project}"
        ...
        run_gitlabform(config_delete_secret_variable, group_and_project_name)

        secret_variables = gitlab.get_secret_variables(group_and_project_name)
        assert len(secret_variables) == 0

    def test__reset_single_secret_variable(self, gitlab, group, project):
        group_and_project_name = f"{group}/{project}"
        ...
        run_gitlabform(config_single_secret_variable2, group_and_project_name)

        secret_variables = gitlab.get_secret_variables(group_and_project_name)
        assert len(secret_variables) == 1
        assert secret_variables[0]["value"] == "123456"

    def test__more_secret_variables(self, gitlab, group, project):
        group_and_project_name = f"{group}/{project}"
        ...
        run_gitlabform(config_more_secret_variables, group_and_project_name)
